...
def parse_args():
    ...
    # GA Hyperparameters
    parser.add_argument(
        "--pop-size", type=int, default=100, help="Population size (acts as batch size)"
    )
    parser.add_argument(
        "--top-k", type=int, default=10, help="Number of parents selected for the next generation"
    )
    parser.add_argument("--generations", type=int, default=20, help="Number of evolution rounds")
    parser.add_argument(
        "--mutation-rate", type=int, default=1, help="Number of mutations to introduce per child"
    )

    # Constraints
    parser.add_argument(
        "--max-mutations", type=int, default=10, help="Max mutations allowed relative to seed"
    )
    parser.add_argument(
        "--mask-region",
        type=str,
    ...
    parser.add_argument(
        "--oracle-chunk-size", type=int, default=2000, help="Batch size for oracle inference"
    )
