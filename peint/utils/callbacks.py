...
class ValidationLikelihoodCallback(Callback):
    ...
    Only argument is whether the time keys from the validation step already correspond to
    the quantized bins or real time.


    Args:
        time_quantized: bool - whether the time is quantized or not.

    """

    def __init__(self, time_quantized: bool = False):
        super().__init__()
